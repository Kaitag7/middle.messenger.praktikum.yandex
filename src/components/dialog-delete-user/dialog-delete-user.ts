    ...
    return `
            {{#Dialog open=isOpenDialogDeleteUser}}
                <form method="dialog">
                    ...
                    <div>
                        {{{ Button label="Убрать" type="primary" onClick=onSave }}}
...
export const withStoreDialogDeleteUser = connect((state) => ({
  isOpenDialogDeleteUser: state.isOpenDialogDeleteUser,
}))(DialogDeleteUser);
